...
class TestIschaemiaConstants:
    ...
    def test_stemi_mimic_classes_present(self) -> None:
        """US-073: Verify all 5 STEMI mimic / subtle ischaemia classes."""
        expected = {
...
class TestIschaemiaHeadIntegration:
    ...
    def test_backbone_attention_to_head(self) -> None:
        ...
        head = IschaemiaHead(feature_dim=240)
    ...
    def test_end_to_end_gradient(self) -> None:
        ...
        backbone = AorticaBackbone(in_channels=12, feature_dim=240)
        attention = CrossLeadAttention(feature_dim=240, num_leads=12)
        head = IschaemiaHead(feature_dim=240, dropout=0.0)
