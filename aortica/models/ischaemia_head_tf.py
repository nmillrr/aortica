...
10 sigmoid outputs for ischaemic and metabolic ECG pattern classification.
...
def build_ischaemia_head_tf(
    ...
    * Dense(10) + Sigmoid
    ...
    Returns:
        A ``keras.Model`` with sigmoid output of shape ``(batch, 10)``.
    """
    _check_tf()
